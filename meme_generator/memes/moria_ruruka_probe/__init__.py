...
add_meme(
    "moria_ruruka_probe",  # 模板的唯一标识符
    moria_ruruka_probe,  # 处理函数
    min_images=1,  # 需要的最小图片数量
    max_images=1,  # 需要的最大图片数量
    keywords=["露露卡探头","森亚露露卡探头"],  # 搜索关键词
    date_created=datetime(2026, 2, 23),  # 创建日期
    date_modified=datetime(2026, 2, 23),  # 修改日期
)